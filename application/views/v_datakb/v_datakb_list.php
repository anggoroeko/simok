        ...
        <div class="box">
              ...
              <div class="panel-body ">
                <form id="form-filter" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <a target="_blank" href="datakb/export_excel">
                          <button type="button" class="btn btn-success">Export KB</button>
                        </a>
                </form>
              </div>
            </div>
            <div class="box-body">
              <div class="table-responsive">
                <table id="data_table_server_kb" class="table table-bordered table-striped">
                  <thead>
                  <tr>

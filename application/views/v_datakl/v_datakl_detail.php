...
<div class="content-wrapper"> <?php //print_r($data); die; ?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-cubes"></i> KL </a></li>
      </ol>
    </section>
            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <dl>
                  ...
                  <dt>File KL</dt>
                  <dd> <a target=_blank href=/datakl/download?url=<?= $data['hits']['hits'][0]['_source']['position_file']?>><img width="10%" src="/assets/dist/img/documents-icon.png"></a> </dd>
                </dl>
              </div>
            </div>
            <!-- /.box-body -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <table id="data_table_server_kb_on_kl" class="table table-bordered table-striped">
                  <thead>
                  <tr>

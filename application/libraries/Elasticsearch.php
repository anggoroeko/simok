...
class ElasticSearch
{
    ...
    public function count($type, $q)
    {
        return $this -> call($type . '/_count?q='. $q);
    }
    ...
    public function advancedquery_province($type, $query)
    {   
        return $this -> call($type . '/_search', 'POST', $query);
    }

    public function advancedquery_count($type, $query)
    {
    ...
    public function add_post($type, $data){
        return $this -> call($type . '/', 'POST', $data);
    }

    public function update_post($type,$_id, $data){
        return $this -> call($type.'/'.$_id.'/_update','POST',$data);
    }

    public function soft_delete($type,$_id, $data){
        return $this -> call($type.'/'.$_id.'/_update','POST',$data	);
    }

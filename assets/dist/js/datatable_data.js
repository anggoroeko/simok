    ...
    $(document).ready(function() {
        ...
        table_kb = $('#data_table_server_kb').DataTable({
            ...
            //"responsive" : true,
            "ajax":{
                url :"/datakb/getData", // json datasource
            ...
            "aoColumns": [{
                ...
                "render" : function(data){
                    ...
                    "render" : function(data){
                        if(typeof data['_source']['position_file'] != "undefined"){
                            return "<center><a target=_blank href=/datakb/download?url="+data['_source']['position_file']+"><img width=70% src = /assets/dist/img/documents-icon.png></a></center>"
                        } else {
                            return ""
                        }
                    }
                ...
                "mRender": function(data, type, full) {
                    ...
                    if(status_user != 1){
                        return '<a style="margin: 5px;" class="btn btn-info" href=/datakb/preview/'+data['_id']+' data-toggle="tooltip" data-placement="left" title="preview">' + '<i class="fa fa-eye"></i>' + '</a>'
                    } else {
                        return '<a style="margin: 5px;" class="btn btn-success" href=/datakb/edit/'+data['_id']+' data-toggle="tooltip" data-placement="left" title="edit">' + '<i class="fa fa-pencil"></i>' + '</a>'+
                        '<a href="/datakb/delete/'+data['_id']+'" style="margin: 5px;" class="btn btn-danger" onClick="deleteDatakb(\''+data['_id']+'\')" data-toggle="tooltip" data-placement="left" title="delete">' + '<i class="fa fa-trash"></i>' + '</a>'+
                        '<a style="margin: 5px;" class="btn btn-info" href=/datakb/preview/'+data['_id']+' data-toggle="tooltip" data-placement="left" title="preview">' + '<i class="fa fa-eye"></i>' + '</a>'
                    }
                }
            }],
                "order": [[ 11, "desc" ]]
        ...
        table_kl = $('#data_table_server_kl').DataTable({
            ...
            //"responsive" : true,
            "ajax":{
                url :"/datakl/getData", // json datasource
                type: "post",  // type of method  ,GET/POST/DELETE
                data: function (data) { //console.log(data.filter_year)
                    data.filter_year = $('#filter_year').val();
                },
            ...
            "aoColumns": [{
                ...
                "render" : function(data){
                    ...
                    "render" : function(data){
                        if(typeof data['_source']['position_file'] != "undefined"){
                            return "<center><a target=_blank href=/datakl/download?url="+data['_source']['position_file']+"><img width=70% src = /assets/dist/img/documents-icon.png></a></center>"
                        } else {
                            return ""
                        }
                    }
                ...
                "mRender": function(data, type, full) {
                    if(status_user != 1){
                        return '<a style="margin: 5px;" class="btn btn-info" href=/datakl/preview/'+data['_id']+' data-toggle="tooltip" data-placement="left" title="preview">' + '<i class="fa fa-eye"></i>' + '</a>'
                    } else {
                        return '<a style="margin: 5px;" class="btn btn-success" href=/datakl/edit/'+data['_id']+' data-toggle="tooltip" data-placement="left" title="edit">' + '<i class="fa fa-pencil"></i>' + '</a>'+
                        '<a href="/datakl/delete/'+data['_id']+'" style="margin: 5px;" class="btn btn-danger" onClick="deleteDatakl(\''+data['_id']+'\')" data-toggle="tooltip" data-placement="left" title="delete">' + '<i class="fa fa-trash"></i>' + '</a>'+
                        '<a style="margin: 5px;" class="btn btn-info" href=/datakl/preview/'+data['_id']+' data-toggle="tooltip" data-placement="left" title="preview">' + '<i class="fa fa-eye"></i>' + '</a>'
                    }
                }
            }],
                "order": [[ 11, "desc" ]]
        ...
        $('#data_table_server_kl_on_kb').DataTable({
            ...
            //"responsive" : true,
            "ajax":{
                url :"/datakb/getDataKlonKb/", // json datasource
                type: "post",  // type of method  ,GET/POST/DELETE
                data : {"no_kb":no_kb},
                error: function(data){
        ...
        $('#data_table_server_kb_on_kl').DataTable({
            ...
            //"responsive" : true,
            "ajax":{
                url :"/datakl/getDataKbonKl/", // json datasource
                type: "post",  // type of method  ,GET/POST/DELETE
                data : {"no_kb" : no_kb},
                error: function(data){
    ...
    $('#data_table_server_user').DataTable({
        ...
        "aoColumns": [{
            ...
            "bSortable": false,
            "mRender": function(data, type, full) {
                return '<a style="margin: 5px;" class="btn btn-success" href=/users/edit/'+data['_id']+' data-toggle="tooltip" data-placement="top" title="edit">' + '<i class="fa fa-pencil"></i>' + '</a>'+
